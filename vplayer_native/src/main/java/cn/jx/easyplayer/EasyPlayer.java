...
public class EasyPlayer {
    ...
    public void setEventCallback(cn.jx.easyplayer.EasyPlayerEventCallback cb) {
    ...
    private native void _setEventCallback(cn.jx.easyplayer.EasyPlayerEventCallback cb);
